...
import org.smal2.presentation.presenter.ListPrivilegedUsersPresenter;
...
@Component
@RequestMapping("/user")
public class ListPrivilegedUsersViewJSON {
	@Autowired
	private UserService userService;

	@RequestMapping(value = "/list_privileged_users", method = RequestMethod.POST)
	@ResponseBody
	public OperationResponse<ListUsersResponse> listPrivilegedUsers(
		...
		try {
			...
			new ListPrivilegedUsersPresenter(view, userService);
